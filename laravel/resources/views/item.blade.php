...
@foreach($var as $v)
 ...
 <td>{{$v->item_id}}</td>
 <td>{{$v->item_name}}</td>
 <td>{{$v->Item_purchase_rate}}</td>
 <td>{{$v->item_sell_rate}}</td>
 
            <td class="text-left">

                                        
                                        <a href="#" onclick="itemedit({{$v->item_id}})" class="btn btn-simple btn-warning btn-icon edit"><i class="material-icons">dvr</i></a>
                                        <a href="itemdelete/{{$v->item_id}}" class="btn btn-simple btn-danger btn-icon remove"><i class="material-icons">close</i></a>
