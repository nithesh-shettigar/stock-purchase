@include('sidebar');
 ...
 <td>{{$v->phone_no}}</td>
  ...
  <td class="text-left"><!--<a  class="btn btn-primary btn-sm"href="vendoredit/{{$v->id}}">EDIT</a>
  <td class="text-right"><!--<a  class="btn btn-primary btn-sm"href="vendoredit/{{$v->id}}">EDIT</a>
	<a  class="btn btn-primary btn-sm"href="vendordelete/{{$v->id}}">DELETE</a></td>
	<a href="#" class="btn btn-simple btn-info btn-icon like"><i class="material-icons">favorite</i></a>-->
 

                                        
                                        <a href="#" onclick="vendoredit({{$v->id}})" class="btn btn-simple btn-warning btn-icon edit"><i class="material-icons">dvr</i></a>
                                        <a href="vendordelete/{{$v->id}}" class="btn btn-simple btn-danger btn-icon remove"><i class="material-icons">close</i></a>
                                    </td>
									</tr>
 @endforeach
                            </tbody>
