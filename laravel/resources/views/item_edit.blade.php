                    ...
                    <div class="card-content">
                        ...
                        <div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="name"
                                   type="text"
                                   required="true"value="{{ $data['v']->item_name}}"
                             />
							 <input class="form-control"
                                   name="id"
                                   type="hidden"
                                   required="true" value="{{ $data['v']->item_id}}"
                             />
                        </div>
						...
						<div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="purchase_rate"
                                   type="number"
                                   required="true" value="{{ $data['v']->Item_purchase_rate}}"
                             />
                        </div>  
						...
						<div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="sell_rate"
                                   type="number"
                                   required="true"  value="{{ $data['v']->item_sell_rate}}"
                             />
                        </div>
