                    ...
                    <div class="card-content">
                        ...
                        <div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="name"
                                   type="text"
                                   required="true" value="{{ $data['v']->customer_name}}"
                             />
							 <input class="form-control"
                                   name="id"
                                   type="hidden"
                                   required="true" value="{{ $data['v']->customer_id}}"
                             />
                        </div>
						...
						<div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="email"
                                   type="email"
                                   required="true" value="{{ $data['v']->customer_email}}"
                             />
                        </div>  
						...
						<div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="phone_no"
                                   type="text"
                                   required="true" value="{{ $data['v']->customer_phone}}"
                             />
                        </div>
