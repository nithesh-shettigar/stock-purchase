...
<li>
 ...
 <td>{{$v->customer_phone}}</td>
  ...
  <td class="text-left">
                                        ...
                                        <a href="#" onclick="customeredit({{$v->customer_id}})" class="btn btn-simple btn-warning btn-icon edit"><i class="material-icons">dvr</i></a>
                                        <a href="customerdelete/{{$v->customer_id}}" class="btn btn-simple btn-danger btn-icon remove"><i class="material-icons">close</i></a>
