...
<li>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-6">
            <div class="card">
                <form id="RegisterValidation" action="purchaseinsert" method="POST">
                        ...
                        <div class="form-group label-floating">
                            <label class="control-label">
                                ...
                                <small>*</small>
									...
									<select class="selectpicker" data-style="select-with-transition" name="item" data-size="7">
						...
						<div class="form-group label-floating">
                            <label class="control-label">
                                ...
                                <small>*</small>
									...
									<select class="selectpicker" data-style="select-with-transition" name="vendor_name" data-size="7">
										 <?php $__currentLoopData = $data['vendors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\HP\Desktop\Desktop\testlaravel\resources\views/create_purchase.blade.php ENDPATH**/ ?>