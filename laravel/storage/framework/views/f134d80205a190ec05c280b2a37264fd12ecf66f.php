...
<div class="row">
 ...
 <div class="card-content text-center">
                        ...
                        <button  class="btn btn-rose btn-fill" onclick="item()">add item</button>
    ...
    <div class="col-lg-12 col-md-12">
		<div class="card ">
			...
			<div class="card-header card-header-text col-md-2" data-background-color="orange">
				<h4 class="card-title ">ITEM</h4>
				<p class="category">item details</p>
			</div>
			<div class="card-content table-responsive">
				<table class="table table-hover">
					<thead class="text-warning">
						<th>ITEM ID</th>
						<th>ITEM Name</th>
						<th>ITEM PURCHASE RATE</th>
						<th>ITEM SELL RATE</th>
...
<?php $__currentLoopData = $var; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	<tr>
 <td><?php echo e($v->item_id); ?></td>
 <td><?php echo e($v->item_name); ?></td>
 <td><?php echo e($v->Item_purchase_rate); ?></td>
 <td><?php echo e($v->item_sell_rate); ?></td>
 
            <td class="text-left">

                                        
                                        <a href="#" onclick="itemedit(<?php echo e($v->item_id); ?>)" class="btn btn-simple btn-warning btn-icon edit"><i class="material-icons">dvr</i></a>
                                        <a href="itemdelete/<?php echo e($v->item_id); ?>" class="btn btn-simple btn-danger btn-icon remove"><i class="material-icons">close</i></a>
 ...
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				...
				<script>
						function itemedit(vid)
						{
							window.location.assign("item_edit?vid="+vid);
						}
						</script>
			</div>
		</div>
...
<?php /**PATH C:\Users\HP\Desktop\Desktop\testlaravel\resources\views/item.blade.php ENDPATH**/ ?>