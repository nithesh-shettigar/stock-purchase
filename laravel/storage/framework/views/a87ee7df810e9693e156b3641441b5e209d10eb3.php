...
function myFunction() {
  window.print();
            ...
            <main>
                <div class="row contacts" style="margin-left:2%">
                    <div class="col-4 invoice-to">
                        ...
                        <h2 class="name" >
                        <?php echo e($temp['bills']->customer_name); ?>

                 </h2>
                        <div><?php echo e($temp['bills']->customer_email); ?></div>
                        <div><?php echo e($temp['bills']->customer_phone); ?></div>
                    </div>
					
                    <div class="col invoice-details"style="margin-left:47%">
                        <h1 class="invoice-id" >INVOICE </h1>
                        <div class="date">date:<?php echo e($temp['bills']->bill_date); ?></div>
    ...
    font-size: 1.2em">
				...
				<tbody>	
			 <?php $__currentLoopData = $temp['details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr style="">
            <th style=" color: #fff;
    font-size: 1.6em;
    background: #3989c6"><?php echo e($t->bill_id); ?></th>
             
 
            <th style="text-align: right;
    font-size: 1.6em"><?php echo e($t->item_name); ?></th>
			 
            <th style="    background: #ddd;text-align: right;
    font-size: 1.6em"><?php echo e($t->quantity); ?></th>
           
            <th style="text-align: right;
    font-size: 1.6em"><?php echo e($t->item_sell_rate); ?></th>
            <th style=" background: #3989c6;
    color: #fff ;text-align: right;
    font-size: 1.6em"><?php echo e($t->total); ?></th>
    ...
    font-size: 1.6em"><?php echo e($temp['bills']->sub_total); ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2">TAX</td>
                            <td style="text-align: right;
    font-size: 1.6em"><?php echo e($temp['bills']->tax); ?></td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2"style="">GRAND TOTAL</td>
                            <td style="text-align: right;
    font-size: 1.6em"><?php echo e($temp['bills']->grand_total); ?></td>
                        </tr>
                    </tfoot>
                </table>
...
</html><?php /**PATH C:\Users\HP\Desktop\Desktop\testlaravel\resources\views/billing.blade.php ENDPATH**/ ?>