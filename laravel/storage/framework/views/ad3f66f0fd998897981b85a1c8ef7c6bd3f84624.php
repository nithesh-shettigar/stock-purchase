...
<li>
 ...
 <li>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-6">
            <div class="card">
                <form id="RegisterValidation" action="itemupdate" method="POST">
                    ...
                    <div class="card-content">
                        ...
                        <div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="name"
                                   type="text"
                                   required="true"value="<?php echo e($data['v']->item_name); ?>"
                             />
							 <input class="form-control"
                                   name="id"
                                   type="hidden"
                                   required="true" value="<?php echo e($data['v']->item_id); ?>"
                             />
                        </div>
						...
						<div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="purchase_rate"
                                   type="number"
                                   required="true" value="<?php echo e($data['v']->Item_purchase_rate); ?>"
                             />
                        </div>  
						...
						<div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="sell_rate"
                                   type="number"
                                   required="true"  value="<?php echo e($data['v']->item_sell_rate); ?>"
                             />
                        </div>

 <div class="card-content text-center">
                        
                        <button type="submit" class="btn btn-rose btn-fill" onclick="demo.showSwal('success-message')">submit</button>
                    </div>
...
<?php /**PATH C:\Users\HP\Desktop\Desktop\testlaravel\resources\views/item_edit.blade.php ENDPATH**/ ?>