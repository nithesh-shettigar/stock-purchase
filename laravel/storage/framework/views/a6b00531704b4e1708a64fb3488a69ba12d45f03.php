...
<li>
 ...
 <td><?php echo e($v->customer_email); ?></td>
 <td><?php echo e($v->customer_phone); ?></td>
           
  <td class="text-left">

                                        
                                        <a href="#" onclick="customeredit(<?php echo e($v->customer_id); ?>)" class="btn btn-simple btn-warning btn-icon edit"><i class="material-icons">dvr</i></a>
                                        <a href="customerdelete/<?php echo e($v->customer_id); ?>" class="btn btn-simple btn-danger btn-icon remove"><i class="material-icons">close</i></a>
 ...
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						...
						<script>
						function customeredit(vid)
						{
							window.location.assign("customer_edit?vid="+vid);
						}
						</script>
                    </div>
                </div><!-- end content-->
...
<?php /**PATH C:\Users\HP\Desktop\Desktop\testlaravel\resources\views/customer.blade.php ENDPATH**/ ?>