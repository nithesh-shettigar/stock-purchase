...
<li>
 ...
 <li>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-6">
            <div class="card">
                <form id="RegisterValidation" action="vendorupdate" method="POST">
                    ...
                    <div class="card-content">
                        ...
                        <div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="name"
                                   type="text"
                                   required="true" value="<?php echo e($data['v']->name); ?>"
                             />
							 <input class="form-control"
                                   name="id"
                                   type="hidden"
                                   required="true" value="<?php echo e($data['v']->id); ?>"
                             />
                        </div>
						...
						<div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="email"
                                   type="email"
                                   required="true" value="<?php echo e($data['v']->email); ?>"
                             />
                        </div>  
						...
						<div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="phone_no"
                                   type="text"
                                   required="true" value="<?php echo e($data['v']->phone_no); ?>"
                             />
                        </div>
...
<?php /**PATH C:\Users\HP\Desktop\Desktop\testlaravel\resources\views/vendor_edit.blade.php ENDPATH**/ ?>