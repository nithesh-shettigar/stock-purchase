...
<li>
 ...
 <li>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-6">
            <div class="card">
                <form id="RegisterValidation" action="customerupdate" method="POST">
                    <div class="card-header card-header-icon col-md-2" data-background-color="rose">
                    ...
                    <div class="card-content">
                        ...
                        <div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="name"
                                   type="text"
                                   required="true" value="<?php echo e($data['v']->customer_name); ?>"
                             />
							 <input class="form-control"
                                   name="id"
                                   type="hidden"
                                   required="true" value="<?php echo e($data['v']->customer_id); ?>"
                             />
                        </div>
						...
						<div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="email"
                                   type="email"
                                   required="true" value="<?php echo e($data['v']->customer_email); ?>"
                             />
                        </div>  
						...
						<div class="form-group label-floating">
                            ...
                            <input class="form-control"
                                   name="phone_no"
                                   type="text"
                                   required="true" value="<?php echo e($data['v']->customer_phone); ?>"
                             />
                        </div>
...
<?php /**PATH C:\Users\HP\Desktop\Desktop\testlaravel\resources\views/customer_edit.blade.php ENDPATH**/ ?>